...
export type MyQuery1QueryVariables = Exact<{ [key: string]: never; }>;


export type MyQuery1Query = { __typename?: 'Query', litemallAd: Array<{ __typename?: 'LitemallAdSelectItem', id: number, name: string }> };

export type MyQuery2QueryVariables = Exact<{ [key: string]: never; }>;


export type MyQuery2Query = { __typename?: 'Query', litemallRole: Array<{ __typename?: 'LitemallRoleSelectItem', name: string, id: number, enabled?: boolean | null }> };


export const MyQuery1Document = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyQuery1"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"litemallAd"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<MyQuery1Query, MyQuery1QueryVariables>;
export const MyQuery2Document = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyQuery2"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"litemallRole"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}}]}}]}}]} as unknown as DocumentNode<MyQuery2Query, MyQuery2QueryVariables>;